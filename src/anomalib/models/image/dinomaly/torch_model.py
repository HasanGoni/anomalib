...
class DinomalyModel(nn.Module):
    ...
    def forward(
        ...
        and returns the reconstruction loss. During inference, it computes
        ...
        Returns:
            torch.Tensor | tuple[torch.Tensor, torch.Tensor]:
                - During training: Scalar loss tensor.
                - During inference: Tuple of (pred_score, anomaly_map) where pred_score has
                  shape (B,) and anomaly_map has shape (B, 1, H, W).
        ...
        return pred_score, anomaly_map_resized
